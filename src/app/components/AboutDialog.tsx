  ...
  return (
    <>
      ...
      <div className={`absolute ${showAbout ? "bounce-up" : "bounce-down"} z-40 left-0 right-0 mx-auto inset-0 w-[866px] bg-background h-[380px] p-11`}>
        ...
        <p className="mb-4">
          Soy <span className="text-primary">Marta López de la Nieta</span>, diseño gráfica establecida en Barcelona!
        </p>
        <p className="mb-4">
          A lo largo de mi formación como diseño he tenido la oportunidad de experimentar con varias <br />
